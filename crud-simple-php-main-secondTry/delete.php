...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        if(mysqli_stmt_execute($stmt)){
            ...
            echo "Algo salio mal, favor de intentarlo más tarde.";
        }
    }
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger fade in">
                            ...
                            <p>¿Estás seguro de querer eliminar este registro?</p><br>
                            <p>
                                <input type="submit" value="Sí, estoy seguro" class="btn btn-danger">
                                <a href="index.php" class="btn btn-default">No, volver</a>
                            </p>
                        </div>
                    </form>
                </div>
